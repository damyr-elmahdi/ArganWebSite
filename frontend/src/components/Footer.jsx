        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com" className="text-black-600 hover:text-black-800 relative group">
              ...
              <a href="https://www.facebook.com/lycee.argan" className="text-black-600 hover:text-black-800 relative group">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
              ...
              <a href="https://x.com" className="text-black-600 hover:text-black-800 relative group">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
